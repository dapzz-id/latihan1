<footer class="bg-gradient-to-r from-blue-800/70 to-blue-600/45 text-white py-10 px-6 mt-16 relative">
    <div class="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-10">
        ...
        <div>
            ...
            <ul class="space-y-2 text-white/80">
                <li><a href="/dashboard" class="hover:text-white">Home</a></li>
    ...
    <div class="text-center text-white/70 text-sm mt-10">
        2025 Infinia. All rights reserved.
    </div>
</footer>
